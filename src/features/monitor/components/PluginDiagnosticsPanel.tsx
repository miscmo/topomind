...
import type { PluginDiagnostics, PluginState, RuntimeBindingRecord, ActivationReason } from '@/plugins'
...
export function PluginDiagnosticsPanel() {
  ...
  const retryActivation = async () => {
    ...
    try {
      await getPluginManager().ensureActivated(selectedPlugin.pluginId, selectedPlugin.lastActivationReason)

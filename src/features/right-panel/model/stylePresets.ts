...
export const EDITOR_STYLE_PRESETS: Array<{ label: string; style: DefaultEditorStyle }> = [
  ...
  { label: '护眼', style: { fontSize: 16, fontFamily: 'document-sans', backgroundColor: '#f7f3e8', textColor: '#3f3a2f', lineHeight: 1.75, contentWidth: 800, blockSpacing: 6, headingSpacingRatio: 1.5, letterSpacing: 0, fontWeight: 400 } },
  { label: '紧凑', style: { fontSize: 14, fontFamily: 'document-sans', backgroundColor: '#ffffff', textColor: '#1f2937', lineHeight: 1.5, contentWidth: 800, blockSpacing: 4, headingSpacingRatio: 1.0, letterSpacing: -0.01, fontWeight: 400 } },
]

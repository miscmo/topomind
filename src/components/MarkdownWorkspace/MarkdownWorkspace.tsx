  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden relative">
        {documentType === 'detail' && (
          <aside
            className={`w-[180px] shrink-0 flex flex-col border-r border-[var(--color-border-light)] bg-gradient-to-b from-[var(--color-surface)] to-[var(--color-bg)] ${detailSidebarCollapsed ? '!w-0 !border-r-0 !bg-transparent overflow-hidden' : ''}`}
        ...
        {documentType === 'detail' && !detailSidebarCollapsed && (
          <div
            className={`w-[6px] h-full cursor-col-resize shrink-0 bg-transparent relative select-none transition-colors duration-[180ms] before:content-[""] before:absolute before:top-0 before:bottom-0 before:left-1/2 before:-translate-x-1/2 before:w-px before:bg-[#e6ebf1] before:transition-all before:duration-[180ms] hover:before:bg-[#7aa2cc] hover:before:shadow-[0_0_0_1px_rgba(122,162,204,0.12)] ${isSidebarResizing ? 'before:!bg-[#7aa2cc] before:!shadow-[0_0_0_1px_rgba(122,162,204,0.12)]' : ''}`}

  ...
  return (
    <div className="flex items-center p-2 px-3 border-b border-[var(--color-border)] bg-[color-mix(in_srgb,var(--color-bg)_88%,transparent)] backdrop-blur-[10px] gap-2 flex-wrap">
      <div className="flex gap-[2px] mr-auto items-center">
        <button type="button" className="flex items-center justify-center w-7 h-7 border-none bg-transparent rounded-lg text-[var(--color-text-secondary)] cursor-pointer transition-all duration-75 text-[14px] hover:bg-[var(--color-hover-bg)] hover:text-[var(--color-text-primary)] active:bg-[var(--color-bg-muted)] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed" title="粗体" onClick={() => handleCommand(toggleBold)}><b>B</b></button>
      ...
      <div className="flex gap-3 items-center">
        <div className="flex bg-[var(--color-bg-muted)] p-[2px] border border-[var(--color-border)] rounded-[9px]">
          <button 
            type="button"
            className={`border-none bg-transparent py-[5px] px-[14px] rounded-[7px] text-[12px] font-semibold text-[var(--color-text-secondary)] cursor-pointer transition-all duration-75 ${viewMode === 'edit' ? 'bg-gradient-to-b from-[var(--color-surface)] to-[var(--color-bg)] text-[var(--color-text-primary)] shadow-[var(--shadow-sm)]' : ''}`}
          ...
          <button 
            type="button"
            className={`border-none bg-transparent py-[5px] px-[14px] rounded-[7px] text-[12px] font-semibold text-[var(--color-text-secondary)] cursor-pointer transition-all duration-75 ${viewMode === 'preview' ? 'bg-gradient-to-b from-[var(--color-surface)] to-[var(--color-bg)] text-[var(--color-text-primary)] shadow-[var(--shadow-sm)]' : ''}`}

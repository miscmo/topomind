import { PERFORMANCE_ACTION, PERFORMANCE_METRICS, type PerformanceMetricId } from './performanceContract'
...
export function extractPerformanceSamples(entries: LogLikeEntry[]): PerformanceSample[] {

...
export default memo(function GraphCanvas({
  ...
  const {
    ...
    allowPaneCreateWhenReadOnly: paneCreateEnabled,
    allowNodeMenuWhenReadOnly: nodeMenuEnabled,
    allowLayoutWhenReadOnly: layoutEnabled,
    allowEdgeWriteWhenReadOnly: edgeWriteEnabled,
  } = actions
  ...
  return (
    ...
    >
      <ReactFlow
        ...
        onConnect={canvasReadOnly && !edgeWriteEnabled ? undefined : graph.onConnect}
        onConnectStart={canvasReadOnly && !edgeWriteEnabled ? undefined : graph.onConnectStart}
        onConnectEnd={canvasReadOnly && !edgeWriteEnabled ? undefined : graph.onConnectEnd}
        connectionRadius={12}
        connectionLineComponent={CardSnappedConnectionLine}

        onNodeClick={graph.onNodeClick as (event: React.MouseEvent, node: Node) => void}
        onNodeContextMenu={canvasReadOnly && !nodeMenuEnabled ? undefined : handleNodeContextMenu}
        onEdgeClick={handleEdgeClick}
        onPaneClick={handlePaneClick}
        onPaneContextMenu={canvasReadOnly && !paneCreateEnabled ? undefined : handlePaneContextMenu}
        onEdgeContextMenu={canvasReadOnly && !edgeWriteEnabled ? undefined : handleEdgeContextMenu}
        ...
        nodesDraggable={!canvasReadOnly || layoutEnabled}
        nodesConnectable={!canvasReadOnly || edgeWriteEnabled}
        elementsSelectable
